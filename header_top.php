<section class="header-top">
		<div class="container">
			<div class="row">
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-6 col-lg-push-3">
					<span class="header-top__menu hidden-lg"><i class="fa fa-bars" aria-hidden="true"></i>меню</span>
					<ul class="header-top__menu hidden-xs hidden-sm hidden-md">
				...
				<div class="col-xs-8 col-sm-4 col-md-4 col-lg-3 col-lg-pull-6">
					<a href="/" class="header-top__logo"><img src="img/faberlic-xs.png" alt=""></a>
				</div>
