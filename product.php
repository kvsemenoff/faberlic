		...
		<div class="container">
			<div class="row">
				<div id="imagehide1" class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<div class="ae-all-proucts">
						<a href="#" class="ae-link">Все продукты</a>
					</div>
					
					<h1 id="h1-temp">Суп со шпинатом</h1>
					
					<span>Продукт моментального приготовления</span> <br>
					<span>Вес: 25 гр.</span>
					

					<div class="ae-base-price">
						<div class="ae-base-price_cell">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="responsive-tabs">
						<h2>О продукте</h2>
						<div class="product-tab_content center">
